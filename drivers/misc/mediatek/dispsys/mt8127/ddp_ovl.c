...
int OVLStart() {
	...
	DISP_REG_SET(DISP_REG_OVL_DUMMY, 0x01);
...
int OVLLayerConfig(unsigned int layer,
	...
	pr_debug("[OVL] layer%d fmt0x%x addr0x%x pitch%d (%d %d %d %d)\n",
		layer, format, addr, src_pitch, dst_x, dst_y, dst_w, dst_h);
