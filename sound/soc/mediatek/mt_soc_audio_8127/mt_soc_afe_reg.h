...
#define AUDIO_CLKCFG_MAX_OFFSET AUDIO_CLK_AUDDIV_1

/* To avoid re-defition of clkmgr */
...
#define AUDPLL_CON0_OFFSET   0x0250
#define AUDPLL_CON1_OFFSET   0x0254/*(APMIXEDSYS_BASE+0x0254) */
...
/*topckgen*/
#define CLK_CFG_5_OFFSET     0x0090
