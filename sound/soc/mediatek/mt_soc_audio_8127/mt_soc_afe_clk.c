...
void mt_afe_set_hdmi_clock_source(uint32_t SampleRate, int apllclksel) /*AudDrv_SetHDMIClkSource*/
{
...
#else
	mt_afe_pll_set_reg(AUDPLL_CON1_OFFSET, apll_sdm_pcw << AUDPLL_SDM_PCW_POS,
	...
	/* Set MCLK clock */
	mt_afe_topck_set_reg(CLK_CFG_5_OFFSET, ck_apll << CLK_APLL_SEL_POS,
	...
	mt_afe_topck_set_reg(CLK_CFG_5_OFFSET, 0x1 << PDN_APLL_POS,
